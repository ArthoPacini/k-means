    ...
    class Benchmark
    {
        ...
        public:
            ...
            ~Benchmark()
            {
                ...
                std::cout << mensagem << std::chrono::duration <double, std::milli> (tempoDeExecucao).count() << " ms" << std::endl;
...
int main()
{
    ...
    std::vector<std::vector<Vec3<double>>> resultado = getClustersKMeans(pontos, 20);
